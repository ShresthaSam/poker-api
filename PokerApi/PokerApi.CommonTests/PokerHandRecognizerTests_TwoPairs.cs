...
{
    [TestClass]
    public class PokerHandRecognizerTests_TwoPairs
    {
        [TestMethod]
        public void IsTwoPairs_Should_Return_False()
        {
            ...
            var result = recognizer.IsTwoPairs(sortedCardItems);
        ...
        [TestMethod]
        public void IsTwoPairs_Should_Return_False_For_FullHouse()
        {
            var recognizer = new PokerHandRecognizer();
            var sortedCardItems = new List<CardItem>
            {
        ...
        [TestMethod]
        public void IsTwoPairs_Should_Return_True_Case1()
        {
            var recognizer = new PokerHandRecognizer();
            var sortedCardItems = new List<CardItem>
            {
            ...
            Assert.IsTrue(result.Item2[0] == 11);
            Assert.IsTrue(result.Item2[1] == 10);
            Assert.IsTrue(result.Item3 == 12);
        }
    }
}
